...
- Simple dependency: `pagination_params`, a pure function with no I/O
- Complex dependency: `get_db`, which reads `app/data/db.json` (our "noSQL" store)
...
~2h45 of levels, solo work plus a quick regroup each. Leaves room for an intro, breaks, and a

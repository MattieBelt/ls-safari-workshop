...
- A `ValidationError` collects *every* failing field at once, not just the first — useful for
  building one clear error message instead of fixing input one field at a time.

...
- **Cost of bugs grows over time** — caught while coding: minutes. Caught in production:
  incident + hotfix + support tickets ("shift-left" testing)
- **Enables CI/CD** — pipelines gate deploys on tests; no tests, no safe automation
